export const de = {
  ...
  cocktails: {
    ...
    glasswareType: 'Glasart',
    selectGlassware: 'Glasart auswählen (optional)',
    glasswareHint: 'Oder eigene Glasart eingeben',
    iceType: 'Eis',
    selectIce: 'Eisart auswählen (optional)',
    iceHint: 'Oder eigene Eisart eingeben',
    substitute: 'Ersatz',
