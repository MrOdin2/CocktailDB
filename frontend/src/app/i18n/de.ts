export const de = {
  ...
  cocktails: {
    ...
    glasswareTypes: 'Glasarten',
    selectGlassware: 'Glasart auswählen',
    typeNewGlassware: 'Oder eigene Glasart eingeben',
    addGlassware: 'Glasart hinzufügen',
    iceTypes: 'Eisarten',
    selectIce: 'Eisart auswählen',
    typeNewIce: 'Oder eigene Eisart eingeben',
  ...
  barkeeper: {
    ...
    recipe: {
      ...
      thisIsVariationOf: 'Dies ist eine Variation von',
