export const en = {
  ...
  cocktails: {
    ...
    glasswareType: 'Glassware',
    selectGlassware: 'Select glassware (optional)',
    glasswareHint: 'Or type a custom glassware type',
    iceType: 'Ice',
    selectIce: 'Select ice type (optional)',
    iceHint: 'Or type a custom ice type',
